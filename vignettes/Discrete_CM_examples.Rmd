...
To replicate the results of @louviere_2000 we can use the following lines of code. Note that for the variables *hinc* and *psize* there is an specification for it to be estimated only for category *air*.
