...
In the following, we will describe in more details the components *(r,F,Z)* and their modalities.
...
mod_ref_log_c <- GLMcat(
  formula = Level ~ Age, ratio = "reference", ref_category = "Very.severe",
...
```{r }
mod2 <- GLMcat(
  formula = Level ~ Age, proportional = "Age", ref_category = "Very.severe",
  data = DisturbedDreams, distribution = "logistic"
)
summary(mod2)
logLik(mod2)
...
The function *GLMcat* has special features for the cumulative models:
